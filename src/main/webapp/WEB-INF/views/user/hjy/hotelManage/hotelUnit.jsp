			...
			<div class="container-fluid">
				<div class="row-no-margin row">
					<div class="main-content">
						<form action="#" class="inner-property-unit-form">
							<div class="m-t-6 m-b-8">
								<h2>등록하고자 하는 숙소 또는 유닛 수</h2>
								<p class="m-b-4">아고다에 등록하고자 하는 숙소 또는 유닛 수를 선택해 주세요</p>
								<div class="m-b-8 panel panel-default">
									<div class="panel-body">
										<div class="property-unit-input form-group">
											<label for="noOfProperties" class="control-label">숙소/유닛
												수</label><span class="input-group"><span
												class="input-group-btn"><span class="input-group-btn"><button
															id="minus-button-noOfProperties"
															data-element-name="property-wizard-number-of-properties-minus-selector"
															type="button"
															class="ficon ficon-minus-thin ficon-14 decrease disabled btn btn-default"></button></span></span><input
												name="noOfProperties" min="1" max="999" step="1"
												data-element-name="property-wizard-number-of-properties-input"
												autocomplete="off" autocorrect="off" type="number"
												id="noOfProperties" class="numeric-input-v2 form-control"
												value="1"><span class="input-group-btn"><button
														id="plus-button-noOfProperties"
														data-element-name="property-wizard-number-of-properties-plus-selector"
														type="button"
														class="ficon ficon-plus-thin ficon-14 increase btn btn-default"></button></span></span>
										</div>
									</div>
								</div>
							</div>
