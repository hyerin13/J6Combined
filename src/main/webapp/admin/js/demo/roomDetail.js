  	...
  	$.ajax ({
    	...
    	success : function(data) {
			...
			let html = `
            	...
            	<label>메인사진</label>
            	<input type="text" name="rimainimg" value="${rimainimg}"><br>
            	<label>추가사진1</label>
            	<input type="text" name="riextraimg1" value="${riextraimg1}"><br>
            	<label>추가사진2</label>
            	<input type="text" name="riextraimg2" value="${riextraimg2}"><br>
