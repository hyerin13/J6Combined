...
public class JoinControllerjhr {
	...
	//프로필사진 입력 선택사항
	public String insert(MembersVo vo, MultipartFile profile, Model model) { //MROFILE->그냥 파일 저장, PROFILE->파일명만 뽑아서 저장
		//업로드 할 폴더의 절대 경로 구하기
		String path=sc.getRealPath("/resources/jhr/profileimg");
